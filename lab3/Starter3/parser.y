...
declaration
  : type ID ';' 
      ...
      ast_allocate(DECLARATION_NODE, $2, $1, NULL, 0); } // Pass 0 is we dont declare const
  | type ID '=' expression ';'
      { yTRACE("declaration -> type ID = expression ;\n"); $$ =
      ast_allocate(DECLARATION_NODE, $2, $1, $4, 0); } // Pass 0 is we dont declare const
  | CONST type ID '=' expression ';'
      { yTRACE("declaration -> CONST type ID = expression ;\n"); $$ =
      ast_allocate(DECLARATION_NODE, $3, $2, $5, 1); // Pass 1 is we declare const
...
statement
  ...
  | ';'
      { yTRACE("statement -> ; \n"); $$ = ast_allocate(BLNK_STMT_NODE); /* TODO? not sure what we need to print here */  }
  ;
...
expression
  ...
  | '!' expression %prec '!'
      { yTRACE("expression -> ! expression \n"); $$ =
      ast_allocate(UNARY_EXPRESSION_NODE, (int) '!', $2); }
  ...
  | expression '<' expression %prec '<'
      ...
      ast_allocate(BINARY_EXPRESSION_NODE, (int) '<', $1, $3); }
